...
// ==============================================================
#ifndef __Wrapped_MLP_fcmp_g8j__HH__
#define __Wrapped_MLP_fcmp_g8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Wrapped_MLP_fcmp_g8j) {
    ...
    SC_CTOR(Wrapped_MLP_fcmp_g8j):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
