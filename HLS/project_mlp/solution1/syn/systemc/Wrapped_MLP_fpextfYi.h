...
// ==============================================================
#ifndef __Wrapped_MLP_fpextfYi__HH__
#define __Wrapped_MLP_fpextfYi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Wrapped_MLP_fpextfYi) {
    ...
    SC_CTOR(Wrapped_MLP_fpextfYi):  ACMP_fpext_comb_U ("ACMP_fpext_comb_U") {
