...
// ==============================================================
#ifndef __Wrapped_MLP_dadd_hbi__HH__
#define __Wrapped_MLP_dadd_hbi__HH__
#include "ACMP_dadd.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Wrapped_MLP_dadd_hbi) {
    ...
    SC_CTOR(Wrapped_MLP_dadd_hbi):  ACMP_dadd_U ("ACMP_dadd_U") {
        ACMP_dadd_U.clk(clk);
