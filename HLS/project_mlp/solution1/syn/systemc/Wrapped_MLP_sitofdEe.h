...
// ==============================================================
#ifndef __Wrapped_MLP_sitofdEe__HH__
#define __Wrapped_MLP_sitofdEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(Wrapped_MLP_sitofdEe) {
    ...
    SC_CTOR(Wrapped_MLP_sitofdEe):  ACMP_sitofp_U ("ACMP_sitofp_U") {
