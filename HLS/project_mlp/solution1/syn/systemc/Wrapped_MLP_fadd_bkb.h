...
// ==============================================================
#ifndef __Wrapped_MLP_fadd_bkb__HH__
#define __Wrapped_MLP_fadd_bkb__HH__
#include "ACMP_fadd.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Wrapped_MLP_fadd_bkb) {
    ...
    SC_CTOR(Wrapped_MLP_fadd_bkb):  ACMP_fadd_U ("ACMP_fadd_U") {
        ACMP_fadd_U.clk(clk);
