...
`define TV_IN_INPUT_STREAM_TDATA "./c.Wrapped_MLP.autotvin_INPUT_STREAM_data_V.dat"
`define TV_IN_INPUT_STREAM_TKEEP "./c.Wrapped_MLP.autotvin_INPUT_STREAM_keep_V.dat"
`define TV_IN_INPUT_STREAM_TSTRB "./c.Wrapped_MLP.autotvin_INPUT_STREAM_strb_V.dat"
`define TV_IN_INPUT_STREAM_TUSER "./c.Wrapped_MLP.autotvin_INPUT_STREAM_user_V.dat"
`define TV_IN_INPUT_STREAM_TLAST "./c.Wrapped_MLP.autotvin_INPUT_STREAM_last_V.dat"
`define TV_IN_INPUT_STREAM_TID "./c.Wrapped_MLP.autotvin_INPUT_STREAM_id_V.dat"
`define TV_IN_INPUT_STREAM_TDEST "./c.Wrapped_MLP.autotvin_INPUT_STREAM_dest_V.dat"
...
module AESL_axi_s_INPUT_STREAM (
    ...
    fifo #(784, 32) fifo_INPUT_STREAM_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(784, 4) fifo_INPUT_STREAM_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(784, 4) fifo_INPUT_STREAM_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(784, 4) fifo_INPUT_STREAM_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(784, 1) fifo_INPUT_STREAM_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(784, 5) fifo_INPUT_STREAM_TID (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(784, 5) fifo_INPUT_STREAM_TDEST (
        .reset(1'b0),
        .write_clock(clk),
